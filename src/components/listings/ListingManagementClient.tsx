...
export function ListingManagementClient() {
  ...
  const fetchMyTours = async () => {
    ...
    try {
      const response = await fetch(`/api/listings?guideId=${userId}`);
      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-4">
          ...
          <button
            ...
            className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors font-semibold flex items-center justify-center sm:justify-start"
          >
          ...
          {filteredTours.map((tour) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between text-sm text-gray-600 mb-6 gap-2">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      className="text-blue-600 hover:text-blue-700 text-sm font-medium px-3 py-1.5 rounded hover:bg-blue-50"
                    >
                      Edit
                    </button>
                    <button
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button
                      ...
                      className="text-gray-600 hover:text-gray-700 text-sm font-medium px-3 py-1.5 rounded hover:bg-gray-100"
                    >
                      View
                    </button>
                    <button
